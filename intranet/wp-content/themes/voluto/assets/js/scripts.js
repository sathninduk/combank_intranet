...
jQuery(document).ready(function ($) {
  ...
  $('.voluto-devices-preview').find('button').on('click', function (event) {
    ...
    if ('desktop' == device) {
      device = 'desktop';
      var deviceControl = $(this).parents('.customize-control-responsive_number').find('.voluto-responsive-wrapper').find('div');
      deviceControl.each(function (index) {
        if ($(this).hasClass('voluto-preview-' + device)) {
  ...
  $(' .wp-full-overlay-footer .devices button ').on('click', function () {
    var device = $(this).attr('data-device');
    $('.voluto-devices-preview li').removeClass('active');
    $('.voluto-devices-preview .' + device).addClass('active');
    $('.voluto-responsive-wrapper div').removeClass('active');
    $('.voluto-responsive-wrapper div.voluto-preview-' + device).addClass('active');
  });
});
/* Typography */
...
jQuery(document).ready(function ($) {
  ...
  $('.voluto-sortable_repeater_control').each(function () {
    ...
    if (numRepeaterItems > 0) {
      ...
      if (numRepeaterItems > 1) {
        ...
        for (i = 1; i < numRepeaterItems; ++i) {
          volutoAppendRow($(this), defaultValuesArray[i]);
        }
      }
    }
  }); // Make our Repeater fields sortable

  $(this).find('.voluto-sortable_repeater.sortable').sortable({
    update: function update(event, ui) {
      volutoGetAllInputs($(this).parent());
    }
  }); // Remove item starting from it's parent element

  $('.voluto-sortable_repeater.sortable').on('click', '.customize-control-sortable-repeater-delete', function (event) {
    ...
    if (numItems > 1) {
      $(this).parent().slideUp('fast', function () {
        ...
        $(this).remove();
        volutoGetAllInputs(parentContainer);
      });
    } else {
      $(this).parent().find('.repeater-input').val('');
      volutoGetAllInputs($(this).parent().parent().parent());
    }
  }); // Add new item

  $('.customize-control-sortable-repeater-add').click(function (event) {
    event.preventDefault();
    volutoAppendRow($(this).parent());
    volutoGetAllInputs($(this).parent());
  }); // Refresh our hidden field if any fields change

  $('.voluto-sortable_repeater.sortable').change(function () {
    volutoGetAllInputs($(this).parent());
  }); // Append a new row to our list of elements

  function volutoAppendRow($element) {
  ...
  function volutoGetAllInputs($element) {
...
jQuery(document).ready(function ($) {
  ...
  var tabs = ['main_header_tabs', 'top_bar_tabs', 'header_hero_tabs', 'blog_single_tabs', 'blog_archives_tabs'];
  $.each(tabs, function (i, val) {
    $('.voluto-customizer-tabs[data-tabs-id="' + val + '"]').find('a').on('click', function () {
      if ($(this).hasClass('tab1')) {
        $(' .tab1').addClass('active');
        $('.voluto-customizer-tabs[data-tabs-id="' + val + '"] .tab2').removeClass('active');
      }

      if ($(this).hasClass('tab2')) {
        $('.voluto-customizer-tabs[data-tabs-id="' + val + '"] .tab1').removeClass('active');
        $('.voluto-customizer-tabs[data-tabs-id="' + val + '"] .tab2').addClass('active');
      }
    });
  });
});
...
jQuery(document).ready(function () {
  jQuery('.customize-control-voluto-checkbox-multiple input[type="checkbox"]').on('change', function () {
...
jQuery(document).ready(function ($) {
  ...
  $('.customize-control-voluto-toggle_switch').each(function () {
