            ...
            <form name="f" method="post" action="" id="mo_ldap_feedback">
                ...
                <div>
                    ...
                    <div style="text-align:center;">
                        ...
                        <br><br>
                        <input type="checkbox" name="get_reply" value="YES" checked>I want to get in touch with your technical team for more assistance.<br> <br><strong>On submitting the feedback your email address would be shared with the miniOrange team for contact purpose.</strong></input>
                        <br><br>
